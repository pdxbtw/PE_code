...
# The prodect of these numbers is 26 x 63 x 78 x 14 = 1788696.
...
for i in range(4):
    ...
    elif i == 2:    # Diagonal 1 search
        for r in range(17):
            for c in range(17):
                a = grid[r][c] * grid[r+1][c+1]
                b = grid[r+2][c+2] * grid[r+3][c+3]
                temp = a * b
                if temp != 0:
                    if temp > max_val:
                        max_val = temp

    else:           # Diagonal 2 search
        for r in range(17):
            for c in range(17):
                a = grid[r+3][c] * grid[r+2][c+1]
                b = grid[r+1][c+2] * grid[r][c+3]
                temp = a * b
                if temp != 0:
                    if temp > max_val:
                        max_val = temp
